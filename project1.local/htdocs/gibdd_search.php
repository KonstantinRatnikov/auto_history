<?php
    ...
    $command ='python C:\Server\domains\project1.local\htdocs\PyScripts\gibdd\main.py '.$vin.' '.$token1.' '.$code1.' '.$token2.' '.$code2.' '.$token3.' '.$code3.' '.$token4.' '.$code4;
    //echo($command);
    //echo("<br>");
    ...
    //Диагностика
    $command_dk = 'python C:\Server\domains\project1.local\htdocs\PyScripts\gibdd\dk.py '.$vin.' '.$token5.' '.$code5;
    exec($command, $exec_res);
